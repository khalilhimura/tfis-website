...
The [capability demonstration](../artifacts/16-capability-demonstration.md) starts with this statement. It is a record of evidence, not a numerical examination or an additional maturity framework. Its fields help you make a claim someone else can question.
...
The [literal C16 input](../artifacts/16-capability-demonstration.md#fresh-input-c16) lets you inspect the combination. These are constructed teaching materials. When performing your own demonstration, keep the expected properties separate from the input you supply to the assistant. Otherwise the answer may already be present in the working packet.
...
Audy can now state a specific next responsibility: rehearse a bounded assisted workflow that produces a source-linked draft and review packet, with her final judgment retained. [Chapter 17](17-the-agentic-workforce.md) turns that responsibility into a delegation contract someone—or an AI agent—can follow.
