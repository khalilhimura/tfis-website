...
Complete the [memory inventory](../artifacts/08-memory-inventory.md) for one task. List the records it depends on and write a small set of questions that a fresh session should answer. Begin from those questions, recover the applicable material, and record where the route succeeds or fails.
