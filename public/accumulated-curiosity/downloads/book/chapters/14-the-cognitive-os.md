...
Without AI, explain what would cause you to stop, what would justify continuing, and what would demonstrate that an accepted change survived. Audy finishes with `operating-manual-v1`, connecting her existing records without replacing their authority. [Chapter 15](15-the-sovereignty-test.md) tests whether that procedure can still work when the familiar environment is no longer the starting point.
