...
Maya leaves with `verdict-ledger-v1` linked to the existing instructions, rationale, and knowledge map. Her current rules remain intact, and the new record makes one judgment reusable without erasing its limits. [Chapter 14](14-the-cognitive-os.md) will put these operations into a routine that can be maintained alongside the work they support.
