...
The [portable inquiry prompt](../artifacts/04-inquiry-prompt.md) provides a reusable version. Copy it into a chat if you want assistance, or use its fields as a checklist for manual review. The content should make sense to a person who has not seen the preceding conversation.
